import{o as d,c as p,a as s,b as o,w as a,u as l,N as i,d as t,e as n,f as r}from"./index-vjD7J2PO.js";const g={style:{padding:"20px 0"}},u={style:{"margin-bottom":"48px"}},m={style:{"margin-bottom":"48px"}},c={style:{padding:"20px 0"}},y={__name:"PaginationFormat",setup(b){return(f,e)=>(d(),p("div",null,[e[29]||(e[29]=s(`<p class="muted" style="margin-bottom:24px;">分頁功能採用關注點分離設計，分為 usePagination（邏輯層）和 AppPagination（展示層）兩個部分。</p><div style="margin-bottom:48px;"><h3 style="font-size:1.25rem;margin-bottom:20px;color:var(--text);">🤝 前後端協作規範</h3><div style="margin-bottom:16px;padding:16px;background:#eff6ff;border-left:3px solid #3b82f6;border-radius:6px;"><p style="color:#1e40af;font-weight:600;margin-bottom:8px;">📌 Request 參數組成</p><ul style="color:#1e40af;line-height:1.8;margin:0;padding-left:20px;"><li><strong>固定參數</strong>：pageNo、pageSize（所有分頁 API 都需要）</li><li><strong>業務參數</strong>：typeId、keyword、startDate 等（視 API 功能需求而定，非必要）</li></ul></div><div class="grid" style="margin-bottom:24px;"><article class="card"><h5 style="margin-bottom:12px;font-size:1rem;color:#059669;">情境 A：只需分頁</h5><pre>POST /api/users/list
